...
If you discover a security vulnerability in Smallholder, please report it responsibly:

1. **Do not** open a public GitHub issue for security vulnerabilities
2. Email the maintainer directly or use [GitHub's private vulnerability reporting](https://github.com/Brave-Clown/smallholder/security/advisories/new)
...
Smallholder is a client-side application that stores all data in the browser's localStorage. No data is sent to external servers unless the user explicitly configures a backend URL.
